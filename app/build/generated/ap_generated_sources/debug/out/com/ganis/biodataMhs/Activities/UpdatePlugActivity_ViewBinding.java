...
public class UpdatePlugActivity_ViewBinding implements Unbinder {
  private UpdatePlugActivity target;

  private View view7f08004b;

  @UiThread
  public UpdatePlugActivity_ViewBinding(UpdatePlugActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public UpdatePlugActivity_ViewBinding(final UpdatePlugActivity target, View source) {
    this.target = target;
    ...
    target.edtJumlahSiswa = Utils.findRequiredViewAsType(source, R.id.edtJumlahMhs, "field 'edtJumlahSiswa'", EditText.class);
  ...
  @CallSuper
  public void unbind() {
    UpdatePlugActivity target = this.target;
    if (target == null) throw new IllegalStateException("Bindings already cleared.");
    this.target = null;

    target.edtNamaKelas = null;
    target.edtNamaWali = null;
    target.edtJumlahSiswa = null;
